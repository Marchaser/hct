...
problem.options = optimoptions('fmincon','Algorithm','interior-point','MaxFunEvals',Inf,'FinDiffRelStep',1e-4,'FinDiffType','central','TypicalX',problem.x0,'TolFun',1e-6,'TolCon',1e-6,'Display','iter','OutputFcn',@outfun);
fmincon(problem);
end
